 ...
 */
public class DesitioinTreeID3Test {
...
//        System.out.println(Arrays.toString(arrays)+": "+ifTrue);
    ...
    public void testGenerateDecisionTree() throws Exception{
        init();
        DecisionTreeID3 test = new DecisionTreeID3();
        test.DEBUG = true;

        DecisionTreeID3.DecisionTreeNode tree = test.generateDecisionTree(quatoValuesList, resultList);
    ...
    public void testGenerateDecitionTree() throws Exception {
        ...
        test.calculateAndSelectQuotaByMinEntropy(quatoValuesList, resultList, availableQuatoIndexList, availableValueIndexList);
    }

    @Test
    public void testGenerateDecisionTree1() throws Exception{
        init();
        DecisionTreeID3<Student> test = new DecisionTreeID3<Student>();
